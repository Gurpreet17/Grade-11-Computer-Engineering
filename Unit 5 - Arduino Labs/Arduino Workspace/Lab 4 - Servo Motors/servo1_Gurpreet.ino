...
Date: 17/06/2020
Description: This circuit controls the servo motor based on the potentiometer knob.
*/
...
void loop() {
  ...
  servoPosition = map(potPosition, 0, 1023, 0, 180); //convert the potentiometer number to a servo position from 0-180
